...
@implementation ExportSelectClient_ipad
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        _myclients = [[NSMutableArray alloc] init];
    }
    return self;
}
...
//    [backButton setTitle:@"Back" forState:UIControlStateNormal];
    ...
    [appDelegate setNaviGationTittle:self with:300 high:44 tittle:@"Export Client"];
...
-(void)initClientData:(NSMutableArray *)_clientArray SelectStly:(BOOL)tmpisAll;
{
	AppDelegate_Shared *appDelegate = (AppDelegate_Shared *)[[UIApplication sharedApplication] delegate];
...
//    [myClient_cell setBackgroundView:backImage];
//    myClient_cell.backgroundColor = [UIColor clearColor];
