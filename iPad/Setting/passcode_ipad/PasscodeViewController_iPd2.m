...
@implementation PasscodeViewController_iPd2
...
//    [cancleBtn setTitle:@"Back" forState:UIControlStateNormal];
    ...
    [appDelegate setNaviGationTittle:self with:300 high:44 tittle:@"Turn Off Passcode"];
...
- (void)enterChar
{
	...
	if ([text length] == 4)
    {
        ...
        {
			appDelegate.appSetting.passcode = @"";
			appDelegate.appSetting.isPasscodeOn = [NSNumber numberWithBool:NO];
