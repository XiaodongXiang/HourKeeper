...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    {
        _logInViewController_ipad.myPageControl.currentPage = 2;
    }
    else if (scrollView.contentOffset.x >= SLIDESHOW_WIDTH)
    {
        _logInViewController_ipad.myPageControl.currentPage = 1;
        UIImageView *littleIcon = (UIImageView *)[self viewWithTag:1];
        littleIcon.image = [UIImage imageNamed:@"ipad_logo_a2"];
    }
    else
    {
        _logInViewController_ipad.myPageControl.currentPage = 0;
        UIImageView *littleIcon = (UIImageView *)[self viewWithTag:1];
        littleIcon.image = [UIImage imageNamed:@"ipad_logo_a1"];
    }
    ...
    if (currentPage != page)
    {
        ...
        currentPage = page;
        [self resetCurrentAnimations];
        //        if (self.didReachPageBlock)
        //            self.didReachPageBlock(page);
    }
