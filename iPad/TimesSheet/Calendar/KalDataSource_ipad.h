...
@protocol KalDataSourceCallbacks_ipad;



@protocol KalDataSource_ipad <NSObject, UITableViewDataSource>
...
@protocol KalDataSourceCallbacks_ipad <NSObject>
- (void)loadedDataSource:(id<KalDataSource_ipad>)dataSource;
@end
...
@interface SimpleKalDataSource_ipad : NSObject <KalDataSource_ipad>
{
}
