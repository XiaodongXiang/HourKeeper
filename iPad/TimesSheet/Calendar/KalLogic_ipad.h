 ...
 *
 */
@interface KalLogic_ipad : NSObject
{
  NSDate *nowMonthFirstDate;
  NSDate *nowMonthLastDate;  
  NSDate *baseDate;
  NSDate *fromDate;
  NSDate *toDate;
...
@property (nonatomic, strong, readonly) NSDate *nowMonthFirstDate;
@property (nonatomic, strong, readonly) NSDate *nowMonthLastDate;
