...
//	tm_zip filetime;
	...
	NSError * error = nil;
	NSDictionary* attr = [[NSFileManager defaultManager] attributesOfItemAtPath:file error:&error];//[[NSFileManager defaultManager] fileAttributesAtPath:file traverseLink:YES];
	if( attr )
	{
