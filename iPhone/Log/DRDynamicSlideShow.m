...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    UIImage *littleIconImage = [UIImage imageNamed:@"logo_little"];
    UIImage *iconIm = [UIImage imageNamed:@"logo_page1"];
    ...
    {
        _logInViewController.myPageControl.currentPage = 2;
        iconImage.image = littleIconImage;
    }
    else if (scrollView.contentOffset.x >= SCREEN_WITH)
    {
        _logInViewController.myPageControl.currentPage = 1;
        iconImage.image = littleIconImage;
    }
    else
    {
        _logInViewController.myPageControl.currentPage = 0;
