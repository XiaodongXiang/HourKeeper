...
@synthesize timeWorkCell;
@synthesize timeWorkLbel;
...
@synthesize noteCell;
@synthesize noteTextV;
@synthesize noteLabel;

@synthesize selectLog;

@synthesize breakTimeCell;
@synthesize breakTimeLbel;
...
@synthesize taxCell;
@synthesize taxSwitch;

@synthesize m_timeStr;
@synthesize m_breakStr;
...
-(void)saveBack
{
    ...
    if (taxSwitch.on != self.selectLog.overtimeFree.boolValue)
    {
...
//    self.selectLog.accessDate = [NSDate date];
    self.selectLog.parse_status = [NSNumber numberWithInt:2];
    [context save:nil];
